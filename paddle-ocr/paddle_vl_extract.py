...
def convert_pdf_to_markdown(
    ...
    pages_res = pipeline.predict(input=str(input_path))
    ...
    for page_idx, res in enumerate(pages_res, start=1):
        ...
        # Markdown + images — PaddleOCR handles this automatically
        res.save_to_markdown(save_path=str(pages_dir / f"page_{page_idx:03d}.md"))

    # Final concatenated markdown
    ...
    print(f"   ├── pages/    (per-page markdown files)")
    print(f"   ├── layout/   (layout detection visualisations)")
